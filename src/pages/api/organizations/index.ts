...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createOrganization() {
    ...
    if (body?.social_media_profile?.length > 0) {
      const create_social_media_profile = body.social_media_profile;
      body.social_media_profile = {
        create: create_social_media_profile,
      };
    } else {
      delete body.social_media_profile;
    }
