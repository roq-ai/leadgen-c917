...
import { getSocialMediaProfiles } from 'apiSdk/social-media-profiles';
...
function DashboardPage() {
  ...
  const socialMediaProfileStat = useSWR<PaginatedInterface<SocialMediaProfileInterface>>(
    () => `/social-media-profiles`,
    () => getSocialMediaProfiles({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    {
      ...
      result: socialMediaProfileStat?.data?.totalCount,
      isLoading: socialMediaProfileStat.isLoading,
    },
    {
      title: 'Customers',
