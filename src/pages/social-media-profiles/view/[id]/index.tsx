...
import { getSocialMediaProfileById } from 'apiSdk/social-media-profiles';
import { SocialMediaProfileInterface } from 'interfaces/social-media-profile';

function SocialMediaProfileViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Social Media Profile Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('social_media_profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/social-media-profiles/edit/${id}`} passHref legacyBehavior>
                    <Button
