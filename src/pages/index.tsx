  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of social media with LeadGen, your ultimate solution for effective and efficient lead generation."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of social media with LeadGen, your ultimate solution for effective and efficient lead generation.`}
            </Text>
            <Box
