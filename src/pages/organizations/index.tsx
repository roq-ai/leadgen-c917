...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'campaign.count', 'customer.count', 'social_media_profile.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('social_media_profile', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'social_media_profile',
          header: 'Social Media Profile',
          accessorKey: 'social_media_profile',
          cell: ({ row: { original: record } }: any) => record?._count?.social_media_profile,
        }
      : null,
