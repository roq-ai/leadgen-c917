...
CREATE TABLE "social_media_profile" (
    ...
    CONSTRAINT "social_media_profile_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "social_media_profile" ADD CONSTRAINT "social_media_profile_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
